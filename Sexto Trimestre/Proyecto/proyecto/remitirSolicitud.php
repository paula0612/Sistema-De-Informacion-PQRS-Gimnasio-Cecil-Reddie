...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
  ...
  <div class="Mensaje1">
    <input class="form-control" type="text" value="  Remitir Solicitud" aria-label="Disabled input example" disabled readonly>
  </div>
  <div class="Mensaje2">
  ...
  <div class="Tabla3">
    ...
    <th>N° radicado</th>
      ...
      <tr>
       ...
       <td>
       <?php
          echo "<form name='sdffg' method='POST' action='motivoSolicitudE.php'>";
          echo "<input type='hidden' name='radicado' value='$sol'>";
          echo "<input class='btn btn-outline-info' type='submit' value='Ver Solicitud'>";
          echo "</form>";
        ?>
        ...
        ?>
            <td>
            <?php
              echo "<form name='sdffg' method='POST' action='enviarDestin.php'>";
              echo "<input type='hidden' name='radicado' value='$sol'>";
              echo "<input class='btn btn-outline-primary' type='submit' value='Enviar Destinatario'>";
              echo "</form>";
            ?>
            </td>
       </tr>
...
if(@$_REQUEST['x']==1){
    ...
    ?>
  <script>
    swal.fire('Excelente!','¡La solicitud fue remitida!','success')
  </script>
    <?php
exit;}