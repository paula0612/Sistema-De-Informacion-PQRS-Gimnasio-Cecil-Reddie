...
$nombre = $resultadoNombre->fetch_object();
    $resultado=$objEstudiante-> consultarSolicitudResuelta($varsession);
...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
    ...
    <div class="Atras">
        <div class="d-grid gap-2 d-md-block">
            <a class="btn btn-warning" href="consultarCorrespondenciaE.php" role="button">Atrás</a>
        </div>
    </div>
    <div class="Cerrar">
   ...
   <?php
      ...
      ?>
        ...
        <td>
        <?php
          echo "<form name='sdffg' method='POST' action='motivoSolicitudEstud.php'>";
       ...
       <?php }if($archivo=="Sin Archivo"){?>
        ...
        <?php
            ...
            echo "<form name='sdffg' method='POST' action='ConsultarDetallesRespuestaER.php'>";
        ...
        <?php $archivo_rta=$estudiante->rsArchivo;
