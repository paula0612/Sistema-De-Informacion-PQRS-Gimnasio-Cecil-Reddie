...
$sql= "SELECT petNombre,petApellido from solicitud  inner join peticionario on 
sdRemitente= idPeticionario where idPeticionario=$varsession and sdEstado='1'";
$resultadoNombre = $objConexion->query($sql);


$objEstudiante = new Estudiante();

$sql="SELECT idSolicitud,sdMotivo,sdAsunto, petNombre,petApellido FROM solicitud inner join peticionario on 
sdRemitente= idPeticionario WHERE idSolicitud='$_REQUEST[radicado]'";
$resultado=$objConexion->query($sql);
            ...
            $resultado2=$objSolicitud->consultarSolicitudes();
