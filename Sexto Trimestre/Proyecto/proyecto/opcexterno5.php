...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
    ...
    <div class="ConsultarE">
        ...
        <a href="consultarCorrespondenciaEx.php"> <img src="../imagenes/consultarcorrespondencia.png" width="90px"
                height="90px"></a>
    </div>

    <div class="RealizarS">
        <h2>Realizar solicitud</h2>
        <a href="enviarSolcitudExterno.php"> <img src="../imagenes/reenviar.png" width="90px" height="90px"></a>
    </div>
