...
$resultado=$objSolicitud->consultarSolicitudResueltasPorRol('2');
...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
  ...
  <div class="Atras">
    <div class="d-grid gap-2 d-md-block">
      <a class="btn btn-warning" href="opcsecretaria2.php" role="button">Atrás</a>
    </div>
  </div>
  <div class="Cerrar">
  ...
  while ($solicitud = $resultado->fetch_object())
  {
	?>
      <tr>
        <td scope="row"><?php  echo  $solicitud->	idSolicitud ?></td>
        <?php           
        ...
        <td>
          <?php
            ...
            echo "<form name='sdffg' method='POST' action='motivoSolicitudSecretaria.php'>";
          ...
          ?>
            ...
            <td>
              ...
              echo "<form name='sdffg' method='POST' action='respuestaSolicitudSecretaria.php'>";
              echo "<input type='hidden' name='radicado' value='$sol'>";
  ...
  <div class="SinResolver">
    <div class="d-grid gap-2 d-md-block">
      <a class="btn btn-danger" href="correspondenciaSinResolverS.php" role="button">Sin resolver</a>
    </div>
...
if(@$_REQUEST['x']==1){
  ...
  <script>
   ...
   tipo_Correspondencia.idTipoCorrespondencia WHERE solicitud.sdDestinatario = 2 and DATE_ADD(solicitud.sdFechaenvio, INTERVAL tipo_correspondencia.tcTiempoRespuesta DAY)
      = CURDATE()";
