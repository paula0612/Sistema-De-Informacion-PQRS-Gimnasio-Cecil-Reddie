...
$resultado=$objEstudiante-> enviarCoordinador();
/*
   ...
   <?php
      ...
      ?>
        ...
        <?php
            ...
            echo "<form name='sdffg' method='POST' action='motivoSolicitudEC.php'>";
...
?>    
        ...
        <?php
            ...
            echo "<form name='sdffg' method='POST' action='respuestaC.php'>";
            echo "<input type='hidden' name='radicado' value='$sol'>";
