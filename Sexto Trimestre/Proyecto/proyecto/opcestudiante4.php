...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
  ...
  <div class="ConsultarE">
    <h2>Consultar correspondencia</h2>
    <a href="consultarCorrespondenciaE.php"> <img src="../imagenes/consultarcorrespondencia.png" width="90px"
        height="90px"></a>
  </div>
  <div class="RealizarS">
    <h2>Realizar solicitud</h2>
    <a href="enviarSolicitudestudiante.php"> <img src="../imagenes/reenviar.png" width="90px" height="90px"></a>
  </div>
