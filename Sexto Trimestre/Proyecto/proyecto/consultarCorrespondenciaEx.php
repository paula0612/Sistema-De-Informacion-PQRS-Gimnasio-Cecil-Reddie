...
$resultado=$objUsExterno->consultarSolicitud($varsession);
...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
  ...
  <div class="Atras">
    <div class="d-grid gap-2 d-md-block">
      <a class="btn btn-warning" href="opcexterno5.php" role="button">Atrás</a>
    </div>
  </div>
  <div class="Cerrar">
  ...
  <div class="Filtro2">
  <a class="btn btn-outline-secondary" href="correspondenciaResueltaEx.php" role="button">Resueltas</a>
  </div>
  <div class="Tabla3">
    <table class="table text-center table-striped table-hover table-sm">
      ...
      <?php
       while ($UsExterno = $resultado->fetch_object())
       {
      ?>
      <tr>
        <td><?php echo $UsExterno->idSolicitud?></td>
        <?php           
          $sol=$UsExterno->idSolicitud;
        ?>
        <td><?php echo $UsExterno->sdAsunto ?></td>
        <td><?php echo $UsExterno->tcNombre ?></td>
        <td><?php echo $UsExterno->sdFechaenvio ?></td>
        <td><?php echo $UsExterno->sdHoraenvio ?></td>
     
      <td>
      <?php
          echo "<form name='sdffg' method='POST' action='motivoSolicitudExterno.php'>";
