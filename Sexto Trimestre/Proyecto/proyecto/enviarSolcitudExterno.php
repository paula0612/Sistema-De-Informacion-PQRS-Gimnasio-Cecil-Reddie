...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
   ...
   <form id="form1" name="form1" method="post" action="enviarSolicitudEx.php" enctype="multipart/form-data">
    <center>
        <table border="4" style="width: 50%;";>
           <td>

            <center> <h1> Solicitud Persona Externa </h1>
           ...
           <p>  <input type="file" id="archivo" name="archivo" accept="application/pdf"></p>
              ...
              <button id="btn" type="submit" class="btn btn-primary">enviar</button><br><br></center>

              <script src="jquery-3.6.0.min.js"></script>
                <script src="sweetalert2.all.min.js"></script>
                <script src="enviarSolicitudEx.php?btn"></script>
