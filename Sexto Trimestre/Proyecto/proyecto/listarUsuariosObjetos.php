...
<html>
    ...
    <div class="banner">
        ...
        <div class="Crear">
            <a class="btn btn-primary" href="frmCrearUsuario.php" role="button">Crear</a>
        </div>

        <div class="Tabla1" width="100%">
            <table class="table text-center table-striped table-hover table-sm" width="80%">
                <tr>
                    <th class="align-middle" width="9%">No Documento</th>
                    ...
                    while ($usuario = $resultado->fetch_object())
                    {
                        ...
                        <tr>
                         ...
                         <td>
                            ...
                            echo "<form name='sdffg' method='POST' action='frmActualizarUsuario.php'>";
                           ...
                           <?php
                            ...
                            echo "<form name='sdffg' method='POST' action='validarEliminarUsuario.php'>";
                            echo "<input type='hidden' name=peticionario value='$documento'>";
