...
<div id="divEncabezado"> <?php include "../vista/encabezado.php";?></div>
    ...
    <a href="listarUsuariosObjetosC.php"> <img src="../imagenes/gestionarusuario1.png" width="90px" height="90px"></a>
  </div>
    <div class="ConsultarC">
        <h2>Consultar correspondencia</h2>
        <a href="alertafinalC.php"> <img src="../imagenes/consultarcorrespondencia.png" width="90px"
                height="90px"></a>
    </div>
