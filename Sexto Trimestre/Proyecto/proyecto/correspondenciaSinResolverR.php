...
$resultado=$objEstudiante-> enviarRector();
/*
   ...
   <?php
      ...
      ?>
        ...
        <?php
            ...
            echo "<form name='sdffg' method='POST' action='motivoSolicitudER.php'>";
        ...
        <?php
            ...
            echo "<form name='sdffg' method='POST' action='respuestaR.php'>";
            echo "<input type='hidden' name='radicado' value='$sol'>";
