...
<html>
    ...
    <body>
        ...
        <div>
            <form method="post" action="validarActualizarUsuario.php"><br>
                        ...
                        <table>
                            <tr>
                                ...
                                <td><label for="petNombre"></label>
                                    <input class="form-control" name="petNombre" type="text"
                                     id="petNombre" pattern="[A-ZÑÁÉÍÓÚa-zñáéíóú  ]+"
                            ...
                            <tr>
                                ...
                                <td><label for="petApellido"></label>
                                    <input class="form-control" name="petApellido" type="text"
                                     id="petApellido" pattern="[A-ZÑÁÉÍÓÚa-zñáéíóú  ]+"
                            ...
                            <tr>
                                ...
                                <td><label for="idPeticionario"></label>
                                    ...
                                    pattern="[0-9]"  aria-label="default input example"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control" name="usNombre" type="text"
                                         id="usNombre" pattern="[a-z0-9._%+-   ]+@[a-z0-9.-]+\.[a-z]{2,}$"
