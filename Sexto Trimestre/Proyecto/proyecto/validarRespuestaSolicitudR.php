...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <?php header("location: consultarCorrespondenciaR.php?x=5");?>
...
exit;
    ...
    ?>
   <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <?php header("location: respuestaR.php?x=2");?>
        <?php
    exit;
}}}else{
    $objRespuesta = new RespuestaSolicitud;
...
$resultado2 = $objRespuesta->cambiarEstado($_REQUEST['radicado']);
    ...
    ?>
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        <?php header("location: consultarCorrespondenciaR.php?x=3");?>
    ...
    exit;
        ...
        ?>
       <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        <?php header("location: respuestaR.php?x=4");?>
            <?php
        exit;
